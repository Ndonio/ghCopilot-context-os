...
Read sequentially. After each document, write a Source Document Summary (Template 1 from `.github/templates/templates.md`) to disk. Then proceed with work using summaries only.
